...
<script type="text/javascript" src="angular_js/js/service/fSearchService.js"></script>
<script type="text/javascript" src="angular_js/js/controller/fSearchController.js"></script>
<!-- lost script end -->
</head>
