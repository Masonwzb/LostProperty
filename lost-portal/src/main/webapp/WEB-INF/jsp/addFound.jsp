...
<script type="text/javascript" src="angular_js/js/service/addFoundService.js"></script>
<script type="text/javascript" src="angular_js/js/controller/addFoundController.js"></script>
<!--图片上传 开始-->
...
<body ng-app="portalRest" ng-controller="addFoundController">
<!-- header start-->
...
<!-- register -->
	<div class="register">
		<div class="container">
			<h3 class="animated wow zoomIn" data-wow-delay=".5s">招领信息发布</h3>
			...
			<div class="add-lostAndFound">
				...
				<form class="animated wow slideInUp" data-wow-delay=".5s">
					...
					<div class="input-group animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
						<span class="input-group-addon" id="basic-addon1"><i class=" glyphicon glyphicon-star"></i></span>
						<input type="text" ng-model="entity.foundPlace" class="form-control" placeholder="拾取地点" aria-describedby="basic-addon1" required="">
					</div>
					...
					<div class="form-inline">
						...
						<div class="input-group animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
							<p class="input-group">
								<span class="input-group-addon" id="basic-addon1"><i class=" glyphicon glyphicon-star"></i></span>
				                <input class="form-control" uib-datepicker-popup="{{format}}" ng-model="entity.foundTime" is-open="pop1.opened" 
				                     placeholder="请选择拾取日期" required="" popup-placement="top" close-text="关闭" clear-text="清空" current-text="今天" alt-input-formats="altInputFormats" datepicker-options="datepickerOptions1"/>
					...
					<div class="input-group animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
						<span class="input-group-addon" id="basic-addon1"><i class="glyphicon glyphicon-lock"></i></span>
						<input type="password" ng-model="confirmPwd2" class="form-control" placeholder="确认管理密码" aria-describedby="basic-addon1" required="">
					</div>
...
<script>
    $(document).ready(function () {
    	$("#imagesFile").fileinput({
	 		...
	 		allowedFileExtensions: ['jpg', 'png', 'gif','webp','jpeg'],
	 		fileActionSettings:{
	 			showRemove: true,
			    showUpload: true,
			    showZoom: false,
